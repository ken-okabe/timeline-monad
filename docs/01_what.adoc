...
++++
<iframe height="780" style="width: 100%;" scrolling="no" title="Monadic FRP (timeline-monad)" src="https://codepen.io/stken2050/embed/MLQVRQ/?height=780&theme-id=36003&default-tab=js,result" frameborder="no" allowtransparency="true" allowfullscreen="true">
